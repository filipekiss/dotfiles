...
# You can set this on your mac via pref pane and use defaults read NSGlobalDomain AppleLanguages -array to read the values
...
# Set screensaver to Aerials if installed
...
# Position Dock at left side of the scree. Possible values are `left, `bottom` and `right`
